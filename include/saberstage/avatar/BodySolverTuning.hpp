...
struct BodySolverTuning {
    ...
    float leanRadiusLegFraction = 0.14F;
    float translationStartLegFraction = 0.18F;
    float translationDwellSeconds = 0.13F;
    float bodyTranslationResponseSeconds = 0.32F;
    float pelvisResponseSeconds = 0.10F;
    float pelvisLeanShare = 0.22F;
    float verticalMotionTranslationSuppressionEyeFraction = 0.08F;
    float maximumPelvisSupportOffsetLegFraction = 0.58F;
    ...
    float supportExitLegFraction = 0.18F;
