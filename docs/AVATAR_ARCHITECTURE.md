...
The current native solver contains measured eye-height scaling, a maximum-three-pass FABRIK spine, conservative shoulders, stateful elbow poles, analytic two-bone arms, planted foot anchors, two-bone legs, and a geometric pelvis lean/crouch estimate. Body-yaw states, stepping, turn steps, jumping, and FBT overrides are intentionally absent.
