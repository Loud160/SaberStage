...
Audit SaberStage as a complete camera, avatar, recording, companion-output, and broadcast product.
...
- camera and avatar tracking/recenter behavior;
...
- avatar loading, IK, culling, calibration, and profile changes;
- configuration versioning, migration, reset behavior, and atomic save;
- repeated-session memory growth;
- UI consistency across camera, preview, record, outputs, avatar, scenes, broadcast, and chat;
...
C. local recording;
D. integrated avatar plus recording;
...
P. the heaviest supported combination of avatar, recording, output, compositor, and chat.
...
- avatar change, disable, reset, recenter, and restart restoration;
...
Do not claim Discord video injection, broad TV compatibility, 1080p60, simultaneous outputs, macOS/Linux behavior, or visual calibration success without direct evidence.
