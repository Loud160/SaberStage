...
7. The center settings page exposes exactly `Reset general settings` and `Factory reset SaberStage`; the left panel exposes no premature camera actions, and no preview, recording, companion, scene, broadcast, or chat controls appear.
